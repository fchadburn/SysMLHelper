...
public class CheckForRequirementAnchors extends RPExternalCheck {

	public CheckForRequirementAnchors(
	...
	public boolean check(
		...
		if( ElementToCheck instanceof IRPRequirement ){
			...
			List<IRPModelElement> theAnchoredEls = req.getAnchoredByMe().toList();
			
			if( !theAnchoredEls.isEmpty() ) {
				isOk = false;
			}
		}
	...
	public String getName() {
		return "Requirement has anchored elements";
	}
