...
public class CheckForRequirementNameLength extends RPExternalCheck {

	ExecutableMBSE_Context _context;
	
	public CheckForRequirementNameLength(
	...
	public boolean check(
		...
		if( ElementToCheck instanceof IRPRequirement ){
			...
			if( ElementToCheck.getName().length() > maxLength ) {
				isOk = false;
			}
		}
	...
	public String getName() {
		return "Requirement's name exceeds desirable length to avoid truncation with DOORS Next (as set by RequirementNameLengthMax property)";
	}
