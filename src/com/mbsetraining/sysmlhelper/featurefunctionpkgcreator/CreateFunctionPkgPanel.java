...
public class CreateFunctionPkgPanel extends ExecutableMBSEBasePanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5539811726251239957L;

	public static void main(String[] args) {
		CreateFunctionPkgPanel.launchTheDialog(
				RhapsodyAppServer.getActiveRhapsodyApplication().getApplicationConnectionString() );
	}

	private IRPPackage _invokedFromPkg;
	private CreateFunctionPkgChooser _createPkgChooser;
	...
	public static void launchTheDialog(
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				JFrame frame = new JFrame( "Create a function package" );

				frame.setDefaultCloseOperation( JFrame.DISPOSE_ON_CLOSE );

				CreateFunctionPkgPanel thePanel = 
						new CreateFunctionPkgPanel(
								theAppID );
	...
	public CreateFunctionPkgPanel( 
		...
		String introText = 
				"This helper will create a function package structure. \n";
	...
	private JPanel createContent(){
		...
		_createPkgChooser = new CreateFunctionPkgChooser( 
				_invokedFromPkg, 
				_context.getDefaultFunctionPackageName(),
				_context.getDefaultFunctionPackagePostfix(),
				_context );
