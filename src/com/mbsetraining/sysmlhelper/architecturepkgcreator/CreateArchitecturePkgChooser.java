...
public class CreateArchitecturePkgChooser {
	...
	private final String _doNothingOption = "Skip creation of an architecture package";
	private final String _createNewUnderProjectOption = "Create new architecture package under project";
	private final String _createNewUnderProjectWithStereotypeOptionPre = "Create new «";
	private final String _createNewUnderProjectWithStereotypeOptionPost = "» architecture package under project";
	private final String _createNewUnderPackageOption = "Create new architecture package under owning package";
	private final String _createNewUnderPackageWithStereotypeOptionPre = "Create new «";
	private final String _createNewUnderPackageWithStereotypeOptionPost = "» architecture package under owning package";
	...
	public CreateArchitecturePkgChooser(
		...
		_stereotypeChoicesForPackage = _context.getStereotypeNamesForArchitecturePkg();
	...
	public void createArchitecturePackage(){

		CreateFeaturePkgOption theChoice = getChoice();

		ArchitecturePkgCreator theCreator = new ArchitecturePkgCreator( _context );
		...
		if( theChoice == CreateFeaturePkgOption.CreateUnderPackageWithStereotype ||
			...
			if( !theStereotypeName.isEmpty()) {
				...
				if( theStereotype == null ) {
					_context.warning( "Unable to find stereotype called " + theStereotypeName + " to apply" );
				}
			}
		}
		...
		if( theChoice == CreateFeaturePkgOption.CreateUnderPackage ||
			...
			theCreator.createArchitecturePkg( _invokedFromPkg, thePkgName, theBlockName, theStereotype );


		} else if( theChoice == CreateFeaturePkgOption.CreateUnderProject || 
				theChoice == CreateFeaturePkgOption.CreateUnderProjectWithStereotype ) {
			
			theCreator.createArchitecturePkg( _invokedFromPkg.getProject(), thePkgName, theBlockName, theStereotype );
		}
	}
}
